...
const ContextBuilderHistory = () => {
  ...
  const userFolderRef = ref(storage, `users/${userId}/context-builder`);
  ...
  return (
    <div className="creations">
      <div className="pageheader">
        <div>
          {<ImHistory className="historyicon" />} Context Builder History
        </div>
...
export default ContextBuilderHistory;
